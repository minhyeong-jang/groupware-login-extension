...
var securityEncrypt = (inputStr) => {
  var key = CryptoJS.enc.Utf8.parse("duzon@1234123412");
  var iv = CryptoJS.enc.Utf8.parse("duzon@1234123412");
  var encrypted = CryptoJS.AES.encrypt(CryptoJS.enc.Utf8.parse(inputStr), key, {
    keySize: 128 / 8,
    iv: iv,
